...
class MyWorkload extends WorkloadModuleBase {
    ...
    async initializeWorkloadModule(workerIndex, totalWorkers, roundIndex, roundArguments, sutAdapter, sutContext) {
        ...
        const asset1IDu = `12:21`;
        console.log(`Worker ${this.workerIndex}: Add obs to ${asset1IDu}`);
        const reques1tu = {
            contractId: this.roundArguments.contractId,
            contractFunction: 'UpdateDeviceObsConf',
            invokerIdentity: 'Admin',
        ...
        await this.sutAdapter.sendRequests(reques1tu);
    ...
    //Update evidence, trust and reputation
    async submitTransaction() {
        ...
        console.log(`Worker ${this.workerIndex}: Adds ev to 12:22`);
        const reques3t = {
            contractId: this.roundArguments.contractId,
        ...
        console.log(`Worker ${this.workerIndex}: Adds ev to 12:21`);
        const reques4t = {
            contractId: this.roundArguments.contractId,
            contractFunction: 'UpdateDeviceEvRep',
            invokerIdentity: 'Admin',
        ...
        console.log(`Worker ${this.workerIndex}: Adds ev to 12:23`);
        const reques5t = {
            contractId: this.roundArguments.contractId,
            contractFunction: 'UpdateDeviceEvRep',
            invokerIdentity: 'Admin',
